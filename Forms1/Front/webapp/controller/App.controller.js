    ...
    function (Controller, JSONModel, Core, MessagePopover, Element, MessageItem, library, Message) {
        ...
        return Controller.extend("logaligroup.Front.controller.App", {
            ...
            getGroupName: function (sControlId) {
                ...
                if (oControl) {
                    let sFormSubtitle =
                        oControl.getParent().getParent().getTitle().getText();
                    let sFormTitle =
                        oControl.getParent().getParent().getParent().getTitle();
                ...
                aMessage.forEach(function (sMessage) {
                    switch (sMessage.type) {
                        case "Error":
                            ...
                            break;
                        case "Warning":
                            sIcon = sIcon !== "sap-icon://message-error" ?
                                "sap-icon://message-warning" : sIcon;
                            break;
                        case "Success":
                            sIcon = sIcon !== "sap-icon://message-error" &&
                                sIcon !== "sap-icon://message-warning" ? "sap-icon://message-success" : sIcon;
                            break;
                        default:
                            sIcon = !sIcon ? "sap-icon://message-information"
                                : sIcon;
                            break;
                    };
                });
                ...
                aMessage.forEach(function (sMessage) {
                    switch (sMessage.type) {
                        case "Error":
                            ...
                            break;
                        case "Warning":
                            sHighestSeverity = sHighestSeverity !== "Negative"
                                ? "Critical" : sHighestSeverity;
                            break;
                        case "Success":
                            sHighestSeverity = sHighestSeverity !== "Negative"
                                && sHighestSeverity !== "Critical" ? "Success" : sHighestSeverity;
                            break;
                        default:
                            sHighestSeverity = !sHighestSeverity ? "Neutral" :
                                sHighestSeverity;
                            break;
                    };
                });
                ...
                switch (sHighestSeverityIconType) {
                    ...
                    default:
                        sHighestSeverityMessageType =
                            !sHighestSeverityMessageType ? "Information" : sHighestSeverityMessageType;
                        break;
                };
                return
                this._MessageManager.getMessageModel().oData.reduce(function (iNumberofMessages, oMessageItem) {
            ...
            checkInputConstraints: function (group, oInput) {
                var oBinding = oInput.getBinding("value"),
                    ...
                    type,
                    description,
                    sTarget = oInput.getBindingContext().getPath() + "/" +
                        oInput.getBindingPath("value");
